...
{
  public class GradientLookAndFeel : LookAndFeel
  {
    ...
    public string GetId()
    {
      return _GRADIENT_LOOK_AND_FEEL;
    }
    ...
    private const string  _GRADIENT_LOOK_AND_FEEL = "GradientLookAndFeel";
                                
    private const string  _BORDER = "<Rectangle xmlns=\"http://schemas.microsoft.com/client/2007\" Stroke=\"#004E7E\"/>";

    // chart grid
    private const string _GRID_RECT = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\" Stroke=\"#000000\" StrokeThickness=\"1\"/>";
    private const string _GRID_PATH = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\" Stroke=\"#A0A0A0\" StrokeThickness=\"1\"/>";
    private const string _GRID_PATH_3D = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\" Stroke=\"#000000\" StrokeThickness=\"1\"/>";
    ...
    // funnel 
    private const string _FUNNEL_PATH = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\"/>";

    // Labels
    private const string _Y_LABEL = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"11\" FontFamily=\"Verdana\" Foreground=\"#666666\"/>";
    private const string _GROUP_LABEL = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"11\" FontFamily=\"Verdana\" Foreground=\"#666666\"/>";

    private const string _LEGEND_TEXT = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"11\" FontFamily=\"Verdana\" Foreground=\"#666666\"/>";
    private const string _LEGEND_RECT = "<Rectangle xmlns=\"http://schemas.microsoft.com/client/2007\" Opacity=\".9\" Width=\"8\" Height=\"8\" Stroke=\"#000000\" StrokeThickness=\"1\"/>";

    private const string _TITLE_TEXT = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"14\" FontFamily=\"Verdana\" Foreground=\"#000000\"/>";
    private const string _SUBTITLE_TEXT = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"11\" FontFamily=\"Verdana\" Foreground=\"#666666\"/>";
    private const string _FOOT_NOTE_TEXT = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"9\" FontFamily=\"Verdana\" Foreground=\"#666666\"/>";

    // element gradient
    private const string _ELEMENT_GRADIENT = @"<LinearGradientBrush xmlns=""http://schemas.microsoft.com/client/2007"" StartPoint=""0,0"" EndPoint=""1,0"">
    ...
    // grid gradient
    private const string _GRID_GRADIENT = @"<LinearGradientBrush xmlns=""http://schemas.microsoft.com/client/2007"" StartPoint=""0,0"" EndPoint=""0,1"">
                                            <GradientStop Color=""#B2E4ECF7"" Offset=""0.0""/>
                                            <GradientStop Color=""#B2FFFFFF"" Offset=""1.0""/>
                                            </LinearGradientBrush>";
    // tooltip
    ...
    // The root canvas gives the bounds of the circular gauage. 
    private const string _CIRCULAR_GAUGE = @"<Canvas xmlns=""http://schemas.microsoft.com/client/2007"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" Width=""450"" Height=""450"">
      <!-- The dial shell -->
      <Canvas>
        <Path>
          <Path.Data>
          ...
          <LinearGradientBrush StartPoint=""0,0"" EndPoint=""0,1"">
            <GradientStop Offset=""0.0"" Color=""#E9EDF4""/>
            <GradientStop Offset=""0.2"" Color=""#5B7193""/>
            <GradientStop Offset=""0.8"" Color=""#5B7193""/>
            <GradientStop Offset=""1.0"" Color=""#E9EDF4""/>
          </LinearGradientBrush>
          </Path.Fill>
        </Path>
        <Path StrokeThickness=""0"" Fill=""#203D57"" Opacity="".4"">
        <Path.Data>
        ...
        <Path>
          ...
          <RadialGradientBrush GradientOrigin=""0.5,0.5"" Center=""0.5,0.5"" RadiusX=""0.5"" RadiusY=""0.5"">
            <GradientStop Offset=""0.0"" Color=""#B2FFFFFF""/>
            <GradientStop Offset=""1.0"" Color=""#96E4ECF7""/>
          </RadialGradientBrush>
          </Path.Fill>
        </Path>          
      </Canvas>
      ...
      <Path Data=""M427,225 l6,0 A208,208 0 0,1 329,405 L326,400 A202,202 0 0,0 427,225"">
        <Path.Fill>
          <LinearGradientBrush StartPoint=""0,0"" EndPoint=""0,1"">
            <GradientStop Offset=""0.0"" Color=""#B200FF00""/>
            <GradientStop Offset=""1.0"" Color=""#8099EE99""/>
          </LinearGradientBrush>
        </Path.Fill>
       </Path>
      ...
      <Canvas x:Name=""markerContainer"" Width=""330"">
        <Path Data=""M143,368 L127,394 A195,195 0 1,1 323,394 L308,368 A165,165 0 1,0 143,368"">
          <Path.Fill>
            <LinearGradientBrush StartPoint=""0,0"" EndPoint=""0,1"">
              <GradientStop Offset=""0.0"" Color=""#F0F3F8""/>
              <GradientStop Offset=""0.2"" Color=""#B5D1F8""/>
              <GradientStop Offset=""0.8"" Color=""#B5D1F8""/>
              <GradientStop Offset=""1.0"" Color=""#F0F3F8""/>    
            </LinearGradientBrush>
          </Path.Fill>      
        </Path> 
      </Canvas>
      ...
      <Canvas x:Name=""indicator"" Width=""450"">
        ...
        <Path Fill=""#666666"" Opacity="".5"" StrokeThickness=""0"">
          <Path.Data>
        ...
        <Path Stroke=""#000000"" StrokeThickness=""1"">
          ...
          <Path.Fill>
          <LinearGradientBrush StartPoint=""0,0"" EndPoint=""0,1"">
            <GradientStop Offset=""0.0"" Color=""#EAEAFA""/>
            <GradientStop Offset=""1.0"" Color=""#8A8A8A""/>
          </LinearGradientBrush>
          </Path.Fill>
        </Path> 
      </Canvas>
    ...
    private const string _SEMI_CIRCULAR_GAUGE = @"<Canvas xmlns=""http://schemas.microsoft.com/client/2007"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" Width=""450"" Height=""255"">
      <!-- The dial shell -->
      <Canvas>
        <Path Stroke=""#518EEB"" StrokeThickness=""4""  StrokeLineJoin=""Round""  Data=""M0,225A225,225 0 1,1 450,225 A30,30 0 0,1 420,255 
    ...
    // gauge text  
    private const string _GAUGE_TEXT = "<TextBlock xmlns=\"http://schemas.microsoft.com/client/2007\" FontSize=\"24\" FontFamily=\"Verdana\" Foreground=\"#000000\"/>";

    //guage markers
    private const string _GAUGE_MARKER_MAJOR = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\" Data=\"M0,0 l-30,2 l0,-6 l30,2z\" Opacity=\".8\" Fill=\"#1E3B71\"/>";
    private const string _GAUGE_MARKER_MINOR = "<Path xmlns=\"http://schemas.microsoft.com/client/2007\" Data=\"M-8,1 l-15,0 l0,2 l15,0z\" Opacity=\".8\" Fill=\"#1E3B71\"/>";
  }
}
